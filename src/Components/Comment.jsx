...
export default function Comment() {
  ...
  return (
    <div style={{ width: "400px", margin: "auto", padding: "20px", borderRadius: "10px", boxShadow: "0px 0px 10px rgba(0,0,0,0.1)", background: "white" }}>
      <h1 style={{ textAlign: "center", fontSize: "30px", fontFamily:"cursive" ,color:"black"}}>Name & Comments</h1>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        <input
          ...
          style={{ padding: "10px", border: "1px solid gray", borderRadius: "20px" }}
        />
        <textarea
          value={input.Comment}
          onChange={(e) => setInput({ ...input, Comment: e.target.value })}
          placeholder="Enter Comment"
          style={{ padding: "10px", border: "1px solid gray", borderRadius: "25px", resize: "none", height: "80px" }}
        />
        <button type="submit" style={{ padding: "10px", background: "gray", color: "white", border: "none", borderRadius: "30px", cursor: "pointer" }}>
          Submit
        </button>
      </form>
